...
for ($x = 0; $x < count($results); $x++){
    ...
    echo "<td>" . $orders->get_Quantity($results[$x]['id_products']) . "</td>";
    $total += $results[$x]['price'] * $orders->get_Quantity($results[$x]['id_products']);
    echo "<td><a href='../pages/editOrder.php?&product_name=" . $results[$x]['product_name'] . "&quantity="  . $orders->get_Quantity($results[$x]['id_products']) . "&orderDetailsID="  . $orderDetailsIDArray[$x] . "'" . ">Edit</a></td>";
