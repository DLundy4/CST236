...
--
-- Host: localhost:3306
-- Generation Time: Apr 17, 2020 at 10:58 PM
...
--
ALTER TABLE `orderhistory`
  MODIFY `ID_orderHistory` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `orders_orderdetails`
  MODIFY `ID_order_orderDetails` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `tbl_ecommerce`
--
ALTER TABLE `tbl_ecommerce`
  MODIFY `id_products` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
